...
In this article, we've implemented a helper methods for seemless registration of a PostgreSQL database in a .NET application. Instead of recreating the method from scratch you can use `Persic.EF` package:

```sh
dotnet add package Persic.EF.Postgres
```

With the package installed, you will be able to attach your database with just single line of code:
